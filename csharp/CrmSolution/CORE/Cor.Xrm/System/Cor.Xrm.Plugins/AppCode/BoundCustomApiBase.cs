...
{
    public abstract class BoundCustomApiBase<T> : IPlugin where T : Entity
    {
        public virtual void DefaultMainOperation(BoundCustomApiServiceProvider<T> bcasp)
        {
        }

        public void Execute(IServiceProvider serviceProvider)
        {
            var esp = new BoundCustomApiServiceProvider<T>(serviceProvider);
