...
{% include tip.html content="To simplify your FetchXML creation, use a table view to define filters. Then download the FetchXML from the view for use in your code. This also helps you identify the names of linked entity relationships more easily. {% include image.html file='downloadfetchxml.png' max-width='70%' %}
" %}
